...
function activateLanguageServer(context: vscode.ExtensionContext) {
	...
	let clientOptions: languageClient.LanguageClientOptions = {
		...
		documentSelector: [{scheme: "file", language: "expresso"}],
		synchronize: {
			// Synchronize the setting section 'languageServerExample' to the server
			configurationSection: "expressoLanguageServer",
	...
	let client = new languageClient.LanguageClient("expressoLanguageServer", "Expresso Language Server", serverOptions, clientOptions);
