...
public class Scanner {
	...
	void CheckLiteral() {
		switch (t.val) {
			...
			case "destructor": t.kind = 29; break;
			...
			case "Variadic": t.kind = 41; break;
			case "Tuple": t.kind = 42; break;
			case "List": t.kind = 43; break;
			case "Dictionary": t.kind = 44; break;
			case "Expression": t.kind = 45; break;
