	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 15:
				...
				else if (ch == 'e') {apx = 0; AddCh(); goto case 9;}
				else {t.kind = 9; break;}
			case 16:
				{t.kind = 31; break;}
			case 17:
