...
/*--------------------------------------------------------------------------*/
	...
	void ExprStmt(out Statement stmt) {
		...
		while (!(la.kind == 0 || la.kind == 7)) {SynErr(64); Get();}
		Expect(7);
		if(stmt == null){
	...
	void Block(out Statement block) {
		...
		while (!(la.kind == 0 || la.kind == 29)) {SynErr(69); Get();}
		Expect(29);
	...
	void BreakStmt(out Statement stmt) {
		...
		while (!(la.kind == 0 || la.kind == 7)) {SynErr(72); Get();}
		Expect(7);
	...
	void ContinueStmt(out Statement stmt) {
		...
		while (!(la.kind == 0 || la.kind == 7)) {SynErr(73); Get();}
		Expect(7);
	...
	void Atom(out Expression expr) {
		...
		if (la.kind == 59) {
			...
			while (!(la.kind == 0 || la.kind == 32)) {SynErr(78); Get();}
			Expect(32);
		} else if (la.kind == 57) {
			Get();
			if (StartOf(3)) {
			...
			while (!(la.kind == 0 || la.kind == 58)) {SynErr(79); Get();}
			Expect(58);
		} else if (la.kind == 8) {
			Get();
			if (StartOf(3)) {
			...
			while (!(la.kind == 0 || la.kind == 29)) {SynErr(80); Get();}
			Expect(29);
		} else SynErr(81);
	}
	...
	static readonly bool[,] set = {
		{T,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x},
		{x,T,T,T, T,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,x, x,x,T,x, T,x,x,x, T,x,x,x, x,x,x,T, T,x,x,x, x,T,x,T, T,T,x,x},
		{x,T,T,T, T,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,x, x,x,T,x, x,x,x,x, T,x,x,x, x,x,x,T, T,x,x,x, x,T,x,T, T,T,x,x},
		{x,T,T,T, T,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,T, T,x,x,x, x,T,x,T, T,T,x,x},
		{x,T,T,T, T,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, T,T,x,T, x,x,x,T, x,x,x,x, x,x,T,x, x,x,x,x, T,x,x,x, x,x,x,T, T,x,x,x, x,T,x,T, T,T,x,x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,T,T, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x},
		{x,T,T,T, T,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, T,T,x,T, x,x,T,T, x,x,T,T, x,x,T,x, T,x,x,x, T,x,x,x, x,x,x,T, T,x,x,x, x,T,x,T, T,T,x,x},
		{x,T,T,T, T,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, T,x,x,x, x,T,x,T, T,T,x,x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x},
		{T,T,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x},
		...
		{x,T,T,T, T,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,x,T, T,T,x,x},
		{x,x,T,T, T,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,x,T, T,T,x,x},
		{x,x,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,T,x,x}
...
public class Errors {
	...
	public virtual void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 63: s = "invalid ExprStmt"; break;
			case 64: s = "this symbol not expected in ExprStmt"; break;
			case 65: s = "invalid Type"; break;
			case 66: s = "invalid Stmt"; break;
			case 67: s = "invalid SimpleStmt"; break;
			case 68: s = "invalid CompoundStmt"; break;
			case 69: s = "this symbol not expected in Block"; break;
			case 70: s = "this symbol not expected in PrintStmt"; break;
			case 71: s = "this symbol not expected in ReturnStmt"; break;
			case 72: s = "this symbol not expected in BreakStmt"; break;
			case 73: s = "this symbol not expected in ContinueStmt"; break;
			case 74: s = "invalid Literal"; break;
			case 75: s = "invalid NotTest"; break;
			case 76: s = "invalid Factor"; break;
			case 77: s = "invalid Primary"; break;
			case 78: s = "this symbol not expected in Atom"; break;
			case 79: s = "this symbol not expected in Atom"; break;
			case 80: s = "this symbol not expected in Atom"; break;
			case 81: s = "invalid Atom"; break;
			case 82: s = "invalid TupleOrRange"; break;
